...
namespace Subalcatel\Providers;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'Subalcatel\\Services\\Registrar');
    }
}
namespace Subalcatel\Providers;
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'Subalcatel\\Commands', 'Subalcatel\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class RouteServiceProvider extends ServiceProvider
{
    protected $namespace = 'Subalcatel\\Http\\Controllers';
    public function boot(Router $router)
    {
        parent::boot($router);
    }
